addpath(genpath('C:\Users\salma\MATLAB Drive\T11 MHE\sfhmmpc') );
...
%%
% p.lb1=[0,0,0,p.xn0*p.csn,p.xp1*p.csp,p.rsei,0.5*p.c,0,-1e3];
% p.ub1=[1,1,1,p.xn1*p.csn,p.xp0*p.csp,p.rsei*1e3,p.c,1e-6,1e3];
p.lb1=-30;
p.ub1=30;
